...
// 		add_filter( 'get_twig', array( $this, 'add_to_twig' ) );
  	...
  	function register_stylesheets() {
    	...
    	wp_enqueue_style( 'fa-style', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css', true, $package_version );
  	}
  	
  	function register_scripts() {
  		global $package_version;
  		wp_enqueue_script( 'jquery', 'https://code.jquery.com/jquery-2.2.4.min.js', array(), $package_version, true );
  	}
